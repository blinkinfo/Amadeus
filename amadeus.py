...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "5829411645:AAHtHzzC1hoG8AXelG4Nua09cY9vMGInn4w"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = 'S-One Lite AI BOT'
username = 'princelite_ai_bot'
